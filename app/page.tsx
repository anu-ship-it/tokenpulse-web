...
export default function Home() {
  return (
    <>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <span className="text-[11px] text-text-muted flex items-center gap-1.5">
                <span className="text-teal/40">✓</span> No account needed. Works immediately. No waitlist.
              </span>
            </div>
          </div>
          ...
          <div className="relative flex justify-center md:justify-end">
            ...
            <div className="relative z-10 w-[290px] bg-bg2 border border-border rounded-2xl overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.7),0_0_0_1px_rgba(6,182,212,0.08)]">
              ...
              <div className="px-4 py-4 border-b border-border2">
                ...
                <div className="text-[30px] font-extrabold text-teal tracking-tight leading-none">~41k</div>
                <div className="text-[11px] text-[#5fa8b0] mt-1.5 mb-3">~159k remaining · 20% used</div>
              ...
              <div className="px-4 py-4 border-b border-border2 space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-[12px] font-semibold text-[#7fb8bf]">5-Hour Session</div>
                    <div className="text-[10px] text-[#3a3a3a]">Resets in 3h 14m</div>
                  </div>
                  <div className="text-right">
                    <div className="text-[14px] font-extrabold text-amber-400">79%</div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-[12px] font-semibold text-[#7fb8bf]">7-Day Weekly</div>
                    <div className="text-[10px] text-[#3a3a3a]">Resets in 63h 54m</div>
                  </div>
                  <div className="text-right">
                    <div className="text-[14px] font-extrabold text-teal">26%</div>
                    <div className="w-[64px] h-[3px] bg-bg3 rounded-full overflow-hidden mt-1.5">
            ...
            <div className="hidden md:flex absolute -bottom-7 -left-6 w-64 items-center gap-2.5 bg-bg2 border border-border rounded-xl px-3 py-2 shadow-[0_16px_40px_rgba(0,0,0,0.5)]">
              <span className="text-[9px] font-bold tracking-widest text-[#3a3a3a]">TOKENS</span>
              <div className="flex-1 h-[4px] bg-bg3 rounded-full overflow-hidden">
                <div className="h-full w-[17%] bg-teal rounded-full" />
              </div>
              <span className="text-[11px] font-semibold text-teal whitespace-nowrap">199.3k left</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="flex justify-center px-6 pb-24">
        <div className="flex items-center gap-3 flex-wrap justify-center max-w-[600px]">
          <div className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-bg2 border border-border text-sm font-semibold text-teal shadow-sm">
            <span className="w-[7px] h-[7px] rounded-full bg-teal shadow-[0_0_8px_rgba(6,182,212,0.6)]" /> Works on Claude
          </div>
          <span className="text-xs text-text-muted">+</span>
          <div className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-bg2 border border-border text-sm font-semibold text-teal shadow-sm">
            <span className="w-[7px] h-[7px] rounded-full bg-teal shadow-[0_0_8px_rgba(6,182,212,0.6)]" /> Works on ChatGPT
          </div>
          <span className="text-xs text-text-muted">·</span>
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              ...
              >
                ...
                <div className="text-[13px] text-[#8aa8ac] leading-relaxed mb-3">{f.desc}</div>
        ...
        <div className="max-w-[900px] mx-auto w-full px-4">
          ...
          <div className="bg-bg2 border border-border rounded-2xl p-10 md:p-12 flex flex-col md:flex-row items-center gap-10 shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
            ...
            <div>
              ...
              <div className="text-[13px] text-teal mb-3 font-medium">Builders · Alpha</div>
      ...
      {/* ── CTA ──────────────────────────────────── */}
      <div className="mx-6 md:mx-10 mb-24">
