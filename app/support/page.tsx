          ...
          <div className="w-full max-w-[520px]">
            ...
            {status === "success" ? (
              ...
              <form
                ...
                className="bg-[#0E0E11] border border-white/8 rounded-2x1 p-8 flex flex-col gap-5"
              >
                <div>
                ...
                {status === "error" && (
                  <p className="font-mono text-[10px] text-[#EF4444] text-center">
                    ...
                    <a href="mailto:anup17508@gmail.com" className="underline">
                      anuanup17508@gmail.com
                    </a>
                    directly.
                  </p>
                )}
            ...
            <p className="font-mono text-[11px] text-[#32324A] text-center mt-5 leading-loose">
              Or email{" "}
              <a
