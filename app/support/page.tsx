                ...
                <div className="flex-1 flex items-center justify-center px-6 py-32">
                  <div className="w-full max-w-[520px]">
                    ...
                    <p className="text-[14px] text-[#72728A] leading-relaxed mb-10">
                        Bug, feature request, anything TokenPulse-related. We read every message and usually reply within 24 hours.
                    </p>

                    {status === 'success' ? (
                        <div className="bg-[rgba(0,229,160,0.08)] border border-[rgba(0,229,160,0.18)] rounded-2x1 p-8 text-center">
                            <div className="w-10 h-10 rounded-x1 bg-[rgba(0,229,160,0.12)] border border-[rgba(0,229,160,0.22)] flex items-center justify-center mx-auto mb-4">
                                <div className="w-2.5 h-2.5 rounded-full bg-[#00E5A0] shadow-[0_0_8px_rgba(0,229,160,0.5)]"/>
                                </div>
                                <h2 className="text-[18px]font-bold text-[#EDEEF2] mb-2">Thanks - message sent.</h2>
                                <p className="text-[13px] text-[#72728A]">We usually reply within 24 hours.</p>
                               </div> 
                    ) : (
                        <form onSubmit={handleSubmit} className="bg-[#0E0E11] border border-white/8 rounded-2x1 p-8 flex flex-col gap-5">
                            <div>
                            ...
                            <div>
                                ...
                                <select
                                  ...
                                  className="w-full px-4 py-3 rounded-lg text-sm bg-[#141418] text-[#EDEEF2] border-white/8 focus:border-[rgba(100,95,255,0.4)] outline-none appearance-none cursor-pointer">
                            ...
                            <div>
                                ...
                                <textarea
                                  ...
                                  className={`w-full px-4 py-3 rounded-lg text-sm bg-[#141418] text-[#EDEEF2] placeholder-[#32324A] border outline-none resize-none leading-relaxed transition-colors ${errors.message ? 'border-[#EF4444]' : 'border-white/8 focus:border-[rgba(108,95,255,0.4)]'}`}/>
                            ...
                            {status === 'error' && (
                                <p className="font-mono text-[10px] text-[#EF4444] text-center">
                                    Something went wrong. Email <a href="mailto:anup17508@gmail.com" className="underline">anuanup17508@gmail.com</a>directly.
                                </p>
                            )}
                        </form>
                    )}
