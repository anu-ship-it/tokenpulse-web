            ...
            >
              ...
              <ul className="flex flex-col gap-2.5 mb-7 flex-1">
                {plan.features.map((f) => (
                  <li
                    key={f}
                    className="flex items-start gap-2 text-[13px] text-[#72728A]"
                  >
                    <span className="text-[#00E5A0] flex-shrink-0 mt-0.5">
                      ✓
                    </span>
                    {f}
                  </li>
